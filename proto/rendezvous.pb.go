...
type ConnectRequest struct {
	...
	PrivateAddrs         []*Addr  `protobuf:"bytes,3,rep,name=privateAddrs,proto3" json:"privateAddrs,omitempty"`
...
type PublishRequest struct {
	...
	// PrivateAddrs describes source private addresses.
	PrivateAddrs         []*Addr  `protobuf:"bytes,2,rep,name=privateAddrs,proto3" json:"privateAddrs,omitempty"`
	XXX_NoUnkeyedLiteral struct{} `json:"-"`
	XXX_unrecognized     []byte   `json:"-"`
	XXX_sizecache        int32    `json:"-"`
}
...
type RendezvousReply struct {
	...
	PublicAddr *Addr `protobuf:"bytes,1,opt,name=publicAddr,proto3" json:"publicAddr,omitempty"`
...
func (*RendezvousReply) Descriptor() ([]byte, []int) {
	return fileDescriptor_ef0a1d5737df1c36, []int{2}
}

func (m *RendezvousReply) XXX_Unmarshal(b []byte) error {
	return xxx_messageInfo_RendezvousReply.Unmarshal(m, b)
}
func (m *RendezvousReply) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	return xxx_messageInfo_RendezvousReply.Marshal(b, m, deterministic)
}
func (m *RendezvousReply) XXX_Merge(src proto.Message) {
	xxx_messageInfo_RendezvousReply.Merge(m, src)
}
func (m *RendezvousReply) XXX_Size() int {
	return xxx_messageInfo_RendezvousReply.Size(m)
}
func (m *RendezvousReply) XXX_DiscardUnknown() {
	xxx_messageInfo_RendezvousReply.DiscardUnknown(m)
}

var xxx_messageInfo_RendezvousReply proto.InternalMessageInfo
...
type RendezvousState struct {
	State                map[string]*RendezvousMeeting `protobuf:"bytes,1,rep,name=state,proto3" json:"state,omitempty" protobuf_key:"bytes,1,opt,name=key,proto3" protobuf_val:"bytes,2,opt,name=value,proto3"`
	XXX_NoUnkeyedLiteral struct{}                      `json:"-"`
	XXX_unrecognized     []byte                        `json:"-"`
	XXX_sizecache        int32                         `json:"-"`
}
...
func (*RendezvousState) Descriptor() ([]byte, []int) {
	return fileDescriptor_ef0a1d5737df1c36, []int{3}
}

func (m *RendezvousState) XXX_Unmarshal(b []byte) error {
	return xxx_messageInfo_RendezvousState.Unmarshal(m, b)
}
func (m *RendezvousState) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	return xxx_messageInfo_RendezvousState.Marshal(b, m, deterministic)
}
func (m *RendezvousState) XXX_Merge(src proto.Message) {
	xxx_messageInfo_RendezvousState.Merge(m, src)
}
func (m *RendezvousState) XXX_Size() int {
	return xxx_messageInfo_RendezvousState.Size(m)
}
func (m *RendezvousState) XXX_DiscardUnknown() {
	xxx_messageInfo_RendezvousState.DiscardUnknown(m)
}

var xxx_messageInfo_RendezvousState proto.InternalMessageInfo
...
type RendezvousMeeting struct {
	Clients              map[string]*RendezvousReply `protobuf:"bytes,1,rep,name=clients,proto3" json:"clients,omitempty" protobuf_key:"bytes,1,opt,name=key,proto3" protobuf_val:"bytes,2,opt,name=value,proto3"`
	Servers              map[string]*RendezvousReply `protobuf:"bytes,2,rep,name=servers,proto3" json:"servers,omitempty" protobuf_key:"bytes,1,opt,name=key,proto3" protobuf_val:"bytes,2,opt,name=value,proto3"`
	XXX_NoUnkeyedLiteral struct{}                    `json:"-"`
	XXX_unrecognized     []byte                      `json:"-"`
	XXX_sizecache        int32                       `json:"-"`
}
...
func (*RendezvousMeeting) Descriptor() ([]byte, []int) {
	return fileDescriptor_ef0a1d5737df1c36, []int{4}
}

func (m *RendezvousMeeting) XXX_Unmarshal(b []byte) error {
	return xxx_messageInfo_RendezvousMeeting.Unmarshal(m, b)
}
func (m *RendezvousMeeting) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	return xxx_messageInfo_RendezvousMeeting.Marshal(b, m, deterministic)
}
func (m *RendezvousMeeting) XXX_Merge(src proto.Message) {
	xxx_messageInfo_RendezvousMeeting.Merge(m, src)
}
func (m *RendezvousMeeting) XXX_Size() int {
	return xxx_messageInfo_RendezvousMeeting.Size(m)
}
func (m *RendezvousMeeting) XXX_DiscardUnknown() {
	xxx_messageInfo_RendezvousMeeting.DiscardUnknown(m)
}

var xxx_messageInfo_RendezvousMeeting proto.InternalMessageInfo
...
func (*ResolveMetaReply) Descriptor() ([]byte, []int) {
	return fileDescriptor_ef0a1d5737df1c36, []int{5}
}

func (m *ResolveMetaReply) XXX_Unmarshal(b []byte) error {
	return xxx_messageInfo_ResolveMetaReply.Unmarshal(m, b)
}
func (m *ResolveMetaReply) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	return xxx_messageInfo_ResolveMetaReply.Marshal(b, m, deterministic)
}
func (m *ResolveMetaReply) XXX_Merge(src proto.Message) {
	xxx_messageInfo_ResolveMetaReply.Merge(m, src)
}
func (m *ResolveMetaReply) XXX_Size() int {
	return xxx_messageInfo_ResolveMetaReply.Size(m)
}
func (m *ResolveMetaReply) XXX_DiscardUnknown() {
	xxx_messageInfo_ResolveMetaReply.DiscardUnknown(m)
}

var xxx_messageInfo_ResolveMetaReply proto.InternalMessageInfo
...
func init() {
	...
	proto.RegisterMapType((map[string]*RendezvousMeeting)(nil), "sonm.RendezvousState.StateEntry")
	proto.RegisterType((*RendezvousMeeting)(nil), "sonm.RendezvousMeeting")
	proto.RegisterMapType((map[string]*RendezvousReply)(nil), "sonm.RendezvousMeeting.ClientsEntry")
	proto.RegisterMapType((map[string]*RendezvousReply)(nil), "sonm.RendezvousMeeting.ServersEntry")
...
func (c *rendezvousClient) Resolve(ctx context.Context, in *ConnectRequest, opts ...grpc.CallOption) (*RendezvousReply, error) {
	...
	err := c.cc.Invoke(ctx, "/sonm.Rendezvous/Resolve", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *rendezvousClient) ResolveAll(ctx context.Context, in *ID, opts ...grpc.CallOption) (*ResolveMetaReply, error) {
	...
	err := c.cc.Invoke(ctx, "/sonm.Rendezvous/ResolveAll", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *rendezvousClient) Publish(ctx context.Context, in *PublishRequest, opts ...grpc.CallOption) (*RendezvousReply, error) {
	out := new(RendezvousReply)
	err := c.cc.Invoke(ctx, "/sonm.Rendezvous/Publish", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *rendezvousClient) Info(ctx context.Context, in *Empty, opts ...grpc.CallOption) (*RendezvousState, error) {
	...
	err := c.cc.Invoke(ctx, "/sonm.Rendezvous/Info", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
