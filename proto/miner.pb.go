...
func (NATType) EnumDescriptor() ([]byte, []int) { return fileDescriptor4, []int{0} }
...
func (*MinerInfoRequest) Descriptor() ([]byte, []int) { return fileDescriptor4, []int{0} }
...
func (*MinerHandshakeRequest) Descriptor() ([]byte, []int) { return fileDescriptor4, []int{1} }
...
func (*MinerHandshakeReply) Descriptor() ([]byte, []int) { return fileDescriptor4, []int{2} }
...
func (*MinerStartRequest) Descriptor() ([]byte, []int) { return fileDescriptor4, []int{3} }
...
func (*MinerStartReply) Descriptor() ([]byte, []int) { return fileDescriptor4, []int{4} }
...
func (*MinerStartReplyPort) Descriptor() ([]byte, []int) { return fileDescriptor4, []int{4, 0} }
...
func (*MinerStatusMapRequest) Descriptor() ([]byte, []int) { return fileDescriptor4, []int{5} }
...
func init() { proto.RegisterFile("miner.proto", fileDescriptor4) }
