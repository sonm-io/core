...
func (*UniqueID) Descriptor() ([]byte, []int) { return fileDescriptor3, []int{19} }
...
func (*Timestamp) Descriptor() ([]byte, []int) { return fileDescriptor3, []int{20} }
...
func init() {
	...
	proto.RegisterType((*UniqueID)(nil), "sonm.UniqueID")
...
var fileDescriptor3 = []byte{
	...
	,
}
