...
func (NetworkType) EnumDescriptor() ([]byte, []int) { return fileDescriptor9, []int{0} }
...
func (GPUCount) EnumDescriptor() ([]byte, []int) { return fileDescriptor9, []int{1} }
...
func (TaskStatusReply_Status) EnumDescriptor() ([]byte, []int) { return fileDescriptor9, []int{9, 0} }
...
func (TaskLogsRequest_Type) EnumDescriptor() ([]byte, []int) { return fileDescriptor9, []int{13, 0} }
...
func (*PingReply) Descriptor() ([]byte, []int) { return fileDescriptor9, []int{3} }
...
func (*InfoReply) Descriptor() ([]byte, []int) { return fileDescriptor9, []int{8} }
...
func (*TaskStatusReply) Descriptor() ([]byte, []int) { return fileDescriptor9, []int{9} }
...
func (*AvailableResources) Descriptor() ([]byte, []int) { return fileDescriptor9, []int{10} }
...
func (*StatusMapReply) Descriptor() ([]byte, []int) { return fileDescriptor9, []int{11} }
...
func (*ContainerRestartPolicy) Descriptor() ([]byte, []int) { return fileDescriptor9, []int{12} }
...
func (*TaskLogsRequest) Descriptor() ([]byte, []int) { return fileDescriptor9, []int{13} }
...
func (*TaskLogsChunk) Descriptor() ([]byte, []int) { return fileDescriptor9, []int{14} }
...
func (*DiscoverHubRequest) Descriptor() ([]byte, []int) { return fileDescriptor9, []int{15} }
...
func (*TaskResourceRequirements) Descriptor() ([]byte, []int) { return fileDescriptor9, []int{16} }
...
func (*Chunk) Descriptor() ([]byte, []int) { return fileDescriptor9, []int{17} }
...
func (*Progress) Descriptor() ([]byte, []int) { return fileDescriptor9, []int{18} }
...
func (*Duration) Descriptor() ([]byte, []int) { return fileDescriptor9, []int{19} }
...
func (*EthAddress) Descriptor() ([]byte, []int) { return fileDescriptor9, []int{20} }
...
func (*DataSize) Descriptor() ([]byte, []int) { return fileDescriptor9, []int{21} }
...
func (*DataSizeRate) Descriptor() ([]byte, []int) { return fileDescriptor9, []int{22} }
...
func (*Price) Descriptor() ([]byte, []int) { return fileDescriptor9, []int{23} }
