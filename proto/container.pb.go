...
func (*NetworkSpec) Descriptor() ([]byte, []int) { return fileDescriptor5, []int{0} }
...
func (*Container) Descriptor() ([]byte, []int) { return fileDescriptor5, []int{1} }
...
func init() { proto.RegisterFile("container.proto", fileDescriptor5) }
