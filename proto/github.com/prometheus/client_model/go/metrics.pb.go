...
// Image imports to suppress errors if they are not otherwise used.
var _ = proto.Marshal
var _ = fmt.Errorf
var _ = math.Inf
...
func (MetricType) EnumDescriptor() ([]byte, []int) { return fileDescriptor8, []int{0} }
...
func (*LabelPair) Descriptor() ([]byte, []int) { return fileDescriptor8, []int{0} }
...
func (*Gauge) Descriptor() ([]byte, []int) { return fileDescriptor8, []int{1} }
...
func (*Counter) Descriptor() ([]byte, []int) { return fileDescriptor8, []int{2} }
...
func (*Quantile) Descriptor() ([]byte, []int) { return fileDescriptor8, []int{3} }
...
func (*Untyped) Descriptor() ([]byte, []int) { return fileDescriptor8, []int{5} }
...
func (*Histogram) Descriptor() ([]byte, []int) { return fileDescriptor8, []int{6} }
...
func (*Bucket) Descriptor() ([]byte, []int) { return fileDescriptor8, []int{7} }
...
func (*Metric) Descriptor() ([]byte, []int) { return fileDescriptor8, []int{8} }
...
func (*MetricFamily) Descriptor() ([]byte, []int) { return fileDescriptor8, []int{9} }
...
func init() { proto.RegisterFile("metrics.proto", fileDescriptor8) }
