...
type DealManagementClient interface {
	...
	FinishDeals(ctx context.Context, in *DealsFinishRequest, opts ...grpc.CallOption) (*Empty, error)
	// PurgeDeals finishes all deals where client acts as a consumer
	PurgeDeals(ctx context.Context, in *DealsPurgeRequest, opts ...grpc.CallOption) (*Empty, error)
...
func (c *dealManagementClient) FinishDeals(ctx context.Context, in *DealsFinishRequest, opts ...grpc.CallOption) (*Empty, error) {
	out := new(Empty)
...
func (c *dealManagementClient) PurgeDeals(ctx context.Context, in *DealsPurgeRequest, opts ...grpc.CallOption) (*Empty, error) {
	out := new(Empty)
...
type DealManagementServer interface {
	...
	// FinishDeals finishes deals with given IDs
	FinishDeals(context.Context, *DealsFinishRequest) (*Empty, error)
	// PurgeDeals finishes all deals where client acts as a consumer
	PurgeDeals(context.Context, *DealsPurgeRequest) (*Empty, error)
	// Open tries to open deal between two orders
...
var _DealManagement_FinishDealsCmd = &cobra.Command{
	Use:   "finishDeals",
	Short: "Make the FinishDeals method call, input-type: sonm.DealsFinishRequest output-type: sonm.Empty",
	RunE: grpccmd.RunE(
		"FinishDeals",
...
var _DealManagement_PurgeDealsCmd = &cobra.Command{
	Use:   "purgeDeals",
	Short: "Make the PurgeDeals method call, input-type: sonm.DealsPurgeRequest output-type: sonm.Empty",
	RunE: grpccmd.RunE(
		"PurgeDeals",
...
var fileDescriptor9 = []byte{
	...
	,
}
