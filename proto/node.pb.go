...
func (x *taskManagementLogsClient) Recv() (*Chunk, error) {
	m := new(Chunk)
	if err := x.ClientStream.RecvMsg(m); err != nil {
		return nil, err
	}
...
func (x *taskManagementLogsServer) Send(m *Chunk) error {
	return x.ServerStream.SendMsg(m)
}
...
var _TaskManagement_LogsCmd = &cobra.Command{
	Use:   "logs",
	Short: "Make the Logs method call, input-type: sonm.TaskLogsRequest output-type: sonm.Chunk",
	RunE: grpccmd.RunE(
		"Logs",
...
var fileDescriptor9 = []byte{
	...
	,
}
