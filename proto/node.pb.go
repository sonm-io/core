...
func (*DealsReply) Descriptor() ([]byte, []int) { return fileDescriptor13, []int{2} }
...
type DealManagementClient interface {
	...
	List(ctx context.Context, in *DealListRequest, opts ...grpc.CallOption) (*DealsReply, error)
...
func (c *dealManagementClient) List(ctx context.Context, in *DealListRequest, opts ...grpc.CallOption) (*DealsReply, error) {
	out := new(DealsReply)
...
type DealManagementServer interface {
	// List produces a list of all deals made by client with given ID
	List(context.Context, *DealListRequest) (*DealsReply, error)
	// Status produces a detailed info about deal with given ID.
...
var _DealManagement_ListCmd = &cobra.Command{
	Use:   "list",
	Short: "Make the List method call, input-type: sonm.DealListRequest output-type: sonm.DealsReply",
	RunE: grpccmd.RunE(
		"List",
...
var fileDescriptor13 = []byte{
	...
	,
}
