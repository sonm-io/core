...
type DealManagementClient interface {
	...
	QuickBuy(ctx context.Context, in *ID, opts ...grpc.CallOption) (*Deal, error)
}
...
func (c *dealManagementClient) QuickBuy(ctx context.Context, in *ID, opts ...grpc.CallOption) (*Deal, error) {
	out := new(Deal)
...
type DealManagementServer interface {
	...
	// QuickBuy places BID order with the same parameters as given ASK order have,
	// then opens deal with this two orders.
	QuickBuy(context.Context, *ID) (*Deal, error)
}
...
func _DealManagement_QuickBuy_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(DealManagementServer).QuickBuy(ctx, req.(*ID))
	}
	return interceptor(ctx, in, info, handler)
}
...
var _DealManagement_QuickBuyCmd = &cobra.Command{
	Use:   "quickBuy",
	Short: "Make the QuickBuy method call, input-type: sonm.ID output-type: sonm.Deal",
	RunE: grpccmd.RunE(
		"QuickBuy",
		"sonm.ID",
		func(c io.Closer) interface{} {
...
var _DealManagement_QuickBuyCmd_gen = &cobra.Command{
	Use:   "quickBuy-gen",
	Short: "Generate JSON for method call of QuickBuy (input-type: sonm.ID)",
	RunE:  grpccmd.TypeToJson("sonm.ID"),
}
...
var fileDescriptor9 = []byte{
	...
	,
}
