...
type HubManagementClient interface {
	...
	CreateAskPlan(ctx context.Context, in *InsertSlotRequest, opts ...grpc.CallOption) (*Empty, error)
...
func (c *hubManagementClient) CreateAskPlan(ctx context.Context, in *InsertSlotRequest, opts ...grpc.CallOption) (*Empty, error) {
	out := new(Empty)
...
type HubManagementServer interface {
	...
	// CreateAskPlan allows to create rules
	// for creating Ask orders on Marketplace
	CreateAskPlan(context.Context, *InsertSlotRequest) (*Empty, error)
	// RemoveAskPlan allows to remove rules
	// for creating Ask orders on Marketplace
...
var fileDescriptor8 = []byte{
	...
	,
}
