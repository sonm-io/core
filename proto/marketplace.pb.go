...
func (*OrderIDs) Descriptor() ([]byte, []int) { return fileDescriptor7, []int{0} }
...
func (*Benchmarks) Descriptor() ([]byte, []int) { return fileDescriptor7, []int{2} }
...
func (*Deal) Descriptor() ([]byte, []int) { return fileDescriptor7, []int{3} }
...
func (*Order) Descriptor() ([]byte, []int) { return fileDescriptor7, []int{4} }
...
func (*BidNetwork) Descriptor() ([]byte, []int) { return fileDescriptor7, []int{5} }
...
func (*BidResources) Descriptor() ([]byte, []int) { return fileDescriptor7, []int{6} }
...
func (*BidOrder) Descriptor() ([]byte, []int) { return fileDescriptor7, []int{7} }
...
type MarketClient interface {
	...
	CancelOrders(ctx context.Context, in *OrderIDs, opts ...grpc.CallOption) (*Empty, error)
...
func (c *marketClient) CancelOrders(ctx context.Context, in *OrderIDs, opts ...grpc.CallOption) (*Empty, error) {
	out := new(Empty)
...
type MarketServer interface {
	...
	// CancelOrders removes specified orders from the Marketplace.
	CancelOrders(context.Context, *OrderIDs) (*Empty, error)
	// Purge remove all active orders from marketplace
...
var _Market_CancelOrdersCmd = &cobra.Command{
	Use:   "cancelOrders",
	Short: "Make the CancelOrders method call, input-type: sonm.OrderIDs output-type: sonm.Empty",
	RunE: grpccmd.RunE(
		"CancelOrders",
		"sonm.OrderIDs",
		func(c io.Closer) interface{} {
...
var fileDescriptor7 = []byte{
	...
	,
}
