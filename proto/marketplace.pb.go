...
func (OrderType) EnumDescriptor() ([]byte, []int) { return fileDescriptor11, []int{0} }
...
func (OrderStatus) EnumDescriptor() ([]byte, []int) { return fileDescriptor11, []int{1} }
...
func (IdentityLevel) EnumDescriptor() ([]byte, []int) { return fileDescriptor11, []int{2} }
...
func (DealStatus) EnumDescriptor() ([]byte, []int) { return fileDescriptor11, []int{3} }
...
func (ChangeRequestStatus) EnumDescriptor() ([]byte, []int) { return fileDescriptor11, []int{4} }
...
func (BlacklistType) EnumDescriptor() ([]byte, []int) { return fileDescriptor11, []int{5} }
...
func (*ErrorByID) Descriptor() ([]byte, []int) { return fileDescriptor11, []int{0} }
...
func (*ErrorByID_Item) Descriptor() ([]byte, []int) { return fileDescriptor11, []int{0, 0} }
...
func (*ErrorByStringID) Descriptor() ([]byte, []int) { return fileDescriptor11, []int{1} }
...
func (*ErrorByStringID_Item) Descriptor() ([]byte, []int) { return fileDescriptor11, []int{1, 0} }
...
func (*OrderIDs) Descriptor() ([]byte, []int) { return fileDescriptor11, []int{2} }
...
func (*GetOrdersReply) Descriptor() ([]byte, []int) { return fileDescriptor11, []int{3} }
...
func (*Benchmarks) Descriptor() ([]byte, []int) { return fileDescriptor11, []int{4} }
...
func (*Deal) Descriptor() ([]byte, []int) { return fileDescriptor11, []int{5} }
...
func (*Order) Descriptor() ([]byte, []int) { return fileDescriptor11, []int{6} }
...
func (*BidNetwork) Descriptor() ([]byte, []int) { return fileDescriptor11, []int{7} }
...
func (*BidResources) Descriptor() ([]byte, []int) { return fileDescriptor11, []int{8} }
...
func (*BidOrder) Descriptor() ([]byte, []int) { return fileDescriptor11, []int{9} }
...
func init() { proto.RegisterFile("marketplace.proto", fileDescriptor11) }
