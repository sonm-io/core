...
type PredictSupplierRequest struct {
	Devices              *DevicesReply `protobuf:"bytes,1,opt,name=devices,proto3" json:"devices,omitempty"`
...
func (*PredictSupplierRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_a26373d6c1c91230, []int{0}
}

func (m *PredictSupplierRequest) XXX_Unmarshal(b []byte) error {
	return xxx_messageInfo_PredictSupplierRequest.Unmarshal(m, b)
}
func (m *PredictSupplierRequest) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	return xxx_messageInfo_PredictSupplierRequest.Marshal(b, m, deterministic)
}
func (m *PredictSupplierRequest) XXX_Merge(src proto.Message) {
	xxx_messageInfo_PredictSupplierRequest.Merge(m, src)
}
func (m *PredictSupplierRequest) XXX_Size() int {
	return xxx_messageInfo_PredictSupplierRequest.Size(m)
}
func (m *PredictSupplierRequest) XXX_DiscardUnknown() {
	xxx_messageInfo_PredictSupplierRequest.DiscardUnknown(m)
}

var xxx_messageInfo_PredictSupplierRequest proto.InternalMessageInfo
...
type PredictSupplierReply struct {
	...
	OrderIDs             []*BigInt `protobuf:"bytes,2,rep,name=orderIDs,proto3" json:"orderIDs,omitempty"`
	XXX_NoUnkeyedLiteral struct{}  `json:"-"`
	XXX_unrecognized     []byte    `json:"-"`
	XXX_sizecache        int32     `json:"-"`
}
...
func (*PredictSupplierReply) Descriptor() ([]byte, []int) {
	return fileDescriptor_a26373d6c1c91230, []int{1}
}

func (m *PredictSupplierReply) XXX_Unmarshal(b []byte) error {
	return xxx_messageInfo_PredictSupplierReply.Unmarshal(m, b)
}
func (m *PredictSupplierReply) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	return xxx_messageInfo_PredictSupplierReply.Marshal(b, m, deterministic)
}
func (m *PredictSupplierReply) XXX_Merge(src proto.Message) {
	xxx_messageInfo_PredictSupplierReply.Merge(m, src)
}
func (m *PredictSupplierReply) XXX_Size() int {
	return xxx_messageInfo_PredictSupplierReply.Size(m)
}
func (m *PredictSupplierReply) XXX_DiscardUnknown() {
	xxx_messageInfo_PredictSupplierReply.DiscardUnknown(m)
}

var xxx_messageInfo_PredictSupplierReply proto.InternalMessageInfo
...
func init() { proto.RegisterFile("optimus.proto", fileDescriptor_a26373d6c1c91230) }

var fileDescriptor_a26373d6c1c91230 = []byte{
...
// OrderPredictorClient is the client API for OrderPredictor service.
//
...
func (c *orderPredictorClient) Predict(ctx context.Context, in *BidResources, opts ...grpc.CallOption) (*Price, error) {
	out := new(Price)
	err := c.cc.Invoke(ctx, "/sonm.OrderPredictor/Predict", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *orderPredictorClient) PredictSupplier(ctx context.Context, in *PredictSupplierRequest, opts ...grpc.CallOption) (*PredictSupplierReply, error) {
	...
	err := c.cc.Invoke(ctx, "/sonm.OrderPredictor/PredictSupplier", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
// OrderPredictorServer is the server API for OrderPredictor service.
