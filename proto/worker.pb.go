...
type WorkerManagementClient interface {
	...
	// Schedule maintainance for worker: it will attempt to close all deals till that time point
	ScheduleMaintainance(ctx context.Context, in *Timestamp, opts ...grpc.CallOption) (*Empty, error)
	// Get next planned maintainance
	NextMaintainance(ctx context.Context, in *Empty, opts ...grpc.CallOption) (*Timestamp, error)
}
...
func (c *workerManagementClient) ScheduleMaintainance(ctx context.Context, in *Timestamp, opts ...grpc.CallOption) (*Empty, error) {
	out := new(Empty)
	err := grpc.Invoke(ctx, "/sonm.WorkerManagement/ScheduleMaintainance", in, out, c.cc, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *workerManagementClient) NextMaintainance(ctx context.Context, in *Empty, opts ...grpc.CallOption) (*Timestamp, error) {
	out := new(Timestamp)
	err := grpc.Invoke(ctx, "/sonm.WorkerManagement/NextMaintainance", in, out, c.cc, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type WorkerManagementServer interface {
	...
	// Schedule maintainance for worker: it will attempt to close all deals till that time point
	ScheduleMaintainance(context.Context, *Timestamp) (*Empty, error)
	// Get next planned maintainance
	NextMaintainance(context.Context, *Empty) (*Timestamp, error)
}
...
func _WorkerManagement_ScheduleMaintainance_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(Timestamp)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(WorkerManagementServer).ScheduleMaintainance(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/sonm.WorkerManagement/ScheduleMaintainance",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(WorkerManagementServer).ScheduleMaintainance(ctx, req.(*Timestamp))
	}
	return interceptor(ctx, in, info, handler)
}

func _WorkerManagement_NextMaintainance_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(Empty)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(WorkerManagementServer).NextMaintainance(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/sonm.WorkerManagement/NextMaintainance",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(WorkerManagementServer).NextMaintainance(ctx, req.(*Empty))
	}
	return interceptor(ctx, in, info, handler)
}
...
var _WorkerManagement_serviceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "ScheduleMaintainance",
			Handler:    _WorkerManagement_ScheduleMaintainance_Handler,
		},
		{
			MethodName: "NextMaintainance",
			Handler:    _WorkerManagement_NextMaintainance_Handler,
		},
	},
...
var _WorkerManagement_ScheduleMaintainanceCmd = &cobra.Command{
	Use:   "scheduleMaintainance",
	Short: "Make the ScheduleMaintainance method call, input-type: sonm.Timestamp output-type: sonm.Empty",
	RunE: grpccmd.RunE(
		"ScheduleMaintainance",
		"sonm.Timestamp",
		func(c io.Closer) interface{} {
			cc := c.(*grpc.ClientConn)
			return NewWorkerManagementClient(cc)
...
var _WorkerManagement_ScheduleMaintainanceCmd_gen = &cobra.Command{
	Use:   "scheduleMaintainance-gen",
	Short: "Generate JSON for method call of ScheduleMaintainance (input-type: sonm.Timestamp)",
	RunE:  grpccmd.TypeToJson("sonm.Timestamp"),
}

var _WorkerManagement_NextMaintainanceCmd = &cobra.Command{
	Use:   "nextMaintainance",
	Short: "Make the NextMaintainance method call, input-type: sonm.Empty output-type: sonm.Timestamp",
	RunE: grpccmd.RunE(
		"NextMaintainance",
		"sonm.Empty",
		func(c io.Closer) interface{} {
...
var _WorkerManagement_NextMaintainanceCmd_gen = &cobra.Command{
	Use:   "nextMaintainance-gen",
	Short: "Generate JSON for method call of NextMaintainance (input-type: sonm.Empty)",
	RunE:  grpccmd.TypeToJson("sonm.Empty"),
}
...
func init() {
	...
	_WorkerManagementCmd.AddCommand(
		...
		_WorkerManagement_ScheduleMaintainanceCmd,
		_WorkerManagement_ScheduleMaintainanceCmd_gen,
		_WorkerManagement_NextMaintainanceCmd,
		_WorkerManagement_NextMaintainanceCmd_gen,
	)
}
...
var fileDescriptor14 = []byte{
	...
	,
}
