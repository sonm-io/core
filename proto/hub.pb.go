...
type ExecContractRequest struct {
	Id string `protobuf:"bytes,1,opt,name=id" json:"id,omitempty"`
}

func (m *ExecContractRequest) Reset()                    { *m = ExecContractRequest{} }
func (m *ExecContractRequest) String() string            { return proto.CompactTextString(m) }
func (*ExecContractRequest) ProtoMessage()               {}
func (*ExecContractRequest) Descriptor() ([]byte, []int) { return fileDescriptor2, []int{11} }

func (m *ExecContractRequest) GetId() string {
	if m != nil {
		return m.Id
	}
	return ""
...
type ExecContractReply struct {
}

func (m *ExecContractReply) Reset()                    { *m = ExecContractReply{} }
func (m *ExecContractReply) String() string            { return proto.CompactTextString(m) }
func (*ExecContractReply) ProtoMessage()               {}
func (*ExecContractReply) Descriptor() ([]byte, []int) { return fileDescriptor2, []int{12} }
...
func init() {
	...
	proto.RegisterType((*ExecContractRequest)(nil), "sonm.ExecContractRequest")
	proto.RegisterType((*ExecContractReply)(nil), "sonm.ExecContractReply")
}
...
type HubClient interface {
	...
	ExecContract(ctx context.Context, in *ExecContractRequest, opts ...grpc.CallOption) (*ExecContractReply, error)
}
...
func (c *hubClient) ExecContract(ctx context.Context, in *ExecContractRequest, opts ...grpc.CallOption) (*ExecContractReply, error) {
	out := new(ExecContractReply)
	err := grpc.Invoke(ctx, "/sonm.Hub/ExecContract", in, out, c.cc, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type HubServer interface {
	...
	ExecContract(context.Context, *ExecContractRequest) (*ExecContractReply, error)
}
...
func _Hub_ExecContract_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(ExecContractRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(HubServer).ExecContract(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/sonm.Hub/ExecContract",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(HubServer).ExecContract(ctx, req.(*ExecContractRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var _Hub_serviceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "ExecContract",
			Handler:    _Hub_ExecContract_Handler,
		},
	},
...
var fileDescriptor2 = []byte{
	...
	,
}
