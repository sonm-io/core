...
func TestDWH_monitor(t *testing.T) {
	...
	deal := &pb.Deal{
		...
		AskID:          pb.NewBigIntFromInt(15),
		BidID:          pb.NewBigIntFromInt(25),
		Duration:       10020,
	...
	order := &pb.Order{
		...
		AuthorID:       pb.NewEthAddress(common.HexToAddress("0x8125721C2413d99a33E351e1F6Bb4e56b6b633FE")),
		CounterpartyID: pb.NewEthAddress(common.HexToAddress("0x45")),
		Duration:       10020,
		Price:          pb.NewBigInt(big.NewInt(20010)),
		Netflags:       7,
